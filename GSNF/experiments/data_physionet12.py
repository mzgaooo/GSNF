...
def download_and_process_p12(path_p12):
    ...
    # The PhysioNet12 benchmark uses 37 dynamic clinical variables.
    params = [
...
def get_physionet12_tvt_datasets(args, data_dir, logger):

    path_p12 = data_dir/'PhysioNet12'
    ...
    label_data = pd.read_csv(path_p12/'processed'/'p12_labels.csv')
